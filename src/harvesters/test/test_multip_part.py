...
class TestMultiPart(TestHarvester):
    def test_multipart(self):
        ...
        self.assertEqual(buffer.payload.payload_type, genicam.gentl.PAYLOADTYPE_INFO_IDS.PAYLOAD_TYPE_MULTI_PART)
        ...
        image_rgba = buffer.payload.components[0].data.reshape(height_rgba, width_rgba, 4)
